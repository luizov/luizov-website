...
const ThemeChangerButton = () => {
    return (
        <button
            ...
            className={`flex relative w-10 h-10 rounded-full justify-center items-center ml-3 bg-black bg-opacity-5 border border-blue-600 dark:border-mauveDark-6 shadow-primary group-hover:bg-blue-500 dark:group-hover:bg-spiro-800 group-hover:scale-50 group-hover:border-transparent transition duration-300 ease-out`}
