          ...
          <Menu.Button className="group cursor-pointer outline-none">
            <div className="flex justify-center items-center">
              ...
              <div className={`${open && 'translate-x-6 ease-out'} transition duration-300`}>
                <div className={`${open && 'opacity-0'} font-medium text-lg text-slate-11 dark:text-whiteA-12 group-hover:translate-x-3 transition duration-300 ease-out`}>
                  Menu
                </div>
              </div>
              {/*  round button here */}
              <div className={`flex relative w-11 h-10 rounded-md justify-center items-center ml-3 bg-transparent border border-slate-7 dark:border-whiteA-7 group-hover:bg-blue-9 dark:group-hover:bg-blueDark-9 group-hover:scale-50 group-hover:border-transparent shadow-sm transition duration-300 ease-out`}>
