                    ...
                    <Menu.Button className="group cursor-pointer">
                        <div className="flex justify-center items-center">
                            ...
                            <div className={`${open && 'translate-x-6 ease-out'} transition duration-300`}>
                                <div className={`${open && 'opacity-0'} font-headings font-medium text-lg text-electric-700 dark:text-mauveDark-10 group-hover:translate-x-3 transition duration-300 ease-out`}>
                                    Menu
                                </div>
                            </div>
                            {/*  round button here */}
                            <div className={`flex relative w-12 h-12 rounded-full justify-center items-center ml-3 bg-transparent border border-mauve-7 dark:border-mauveDark-7 group-hover:bg-blue-500 dark:group-hover:bg-violetDark-4 group-hover:scale-50 group-hover:border-transparent transition duration-300 ease-out`}>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className={`${open && 'rotate-90'} h-5 w-5 fill-current text-electric-700 dark:text-mauveDark-10 group-hover:opacity-0 transition duration-150 ease-in`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
