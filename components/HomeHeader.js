        ...
        <section className="relative py-20 pb-24 overflow-hidden">
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
                <div className="flex flex-col items-center text-center">
                    <h1 className="text-5xl sm:text-6xl text-mauve-12 dark:text-mauveDark-12 font-semibold tracking-tight sm:max-w-3xl">
                        {title}
                    </h1>
                    {description &&
                    ...
                    <div className="flex flex-col sm:flex-row items-center space-x-2 mt-8">
                        <a
                            href="#products"
                            className="btn btn-xl btn-primary btn-shadow">
