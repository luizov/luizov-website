            ...
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center space-x-2 mt-6">
                        <a
                            href="#products"
                            className="btn btn-xl text-white bg-blue-500 hover:bg-blue-600 active:bg-blue-700 dark:bg-spiro-800 dark:hover:bg-spiro-700 shadow-primary-xl active:shadow-primary-sm dark:shadow-spiro">
                        ...
                        <Link href="/concepts" passHref>
                            <a
                                className="btn btn-xl text-blue-500 hover:text-blue-600 dark:text-spiro-700 dark:hover:text-spiro-800">
                                Or design concepts
                            </a>
                        </Link>
                    </div>
