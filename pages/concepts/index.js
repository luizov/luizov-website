...
export const PlaygroundImage = ({ src, alt }) => {
	return (
		<div className="relative w-full h-80 bg-slate-4 dark:bg-slateDark-4 rounded-xl overflow-hidden sm:aspect-w-16 sm:aspect-h-12 transition">
			<Image
				src={src}
				alt={alt}
				layout="fill"
		...
		<Page>
			...
			<section className="relative py-16 overflow-hidden">
				<div className="max-w-6xl mx-auto px-4 sm:px-6">
					<div className="mt-12 space-y-4 lg:grid lg:grid-cols-1 lg:gap-x-6">
